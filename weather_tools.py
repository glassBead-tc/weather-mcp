"""
Standalone weather tools for HTTP transport
Direct implementation without FastMCP dependency
"""
...
async def test_weather_api():
    """Test function to verify weather API works"""
    ...
    # Test alerts
    alerts = await get_weather_alerts("Miami")
    print(f"Miami alerts: {alerts}")
    
    # Test comparison
    comparison = await compare_weather(["New York", "Los Angeles"])
